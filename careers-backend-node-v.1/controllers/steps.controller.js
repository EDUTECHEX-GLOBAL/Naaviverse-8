...
const updateStep = async (req, res) => {
  ...
  // ACCESS
  if (req.body.macro_access) updateData.macro_access = req.body.macro_access;
  if (req.body.micro_access) updateData.micro_access = req.body.micro_access;
  if (req.body.nano_access) updateData.nano_access = req.body.nano_access;

  // INSTRUCTIONS
  if (req.body.macro_instructions) updateData.macro_instructions = req.body.macro_instructions;
  if (req.body.micro_instructions) updateData.micro_instructions = req.body.micro_instructions;
  if (req.body.nano_instructions) updateData.nano_instructions = req.body.nano_instructions;
  ...
  let updateStepData = await stepModel.findOneAndUpdate(
