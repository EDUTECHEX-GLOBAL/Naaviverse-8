...
module.exports = {
  addPath, submitForApproval, getPath, deletePath, restorePath,
  getPathSpecific, getPathNormal, updateFields, updatePath,
  getActivePaths, updatePathStatus, reactivatePath,
  reactivateInactivePath, getPathById, uploadBulkPaths,
};