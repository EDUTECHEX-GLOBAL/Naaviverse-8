 ...
 */
export function getOtpEmailContent({ type, otpCode, recipientName, userType, expiresIn = "10 minutes" }) {
  ...
  // Spaced digits for OTP with compact spacing
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 500px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 18px rgba(0, 0, 0, 0.05); border: 1px solid #EAE6DF;">
          ...
          <tr>
            <td style="background-color: #ffffff; padding: 24px 24px 16px; text-align: center; border-bottom: 1px solid #EBE5D8;">
              <img src="https://naavinetwork.ai/logo512.png" alt="naaviverse" style="max-height: 44px; width: auto; max-width: 210px; display: block; margin: 0 auto 6px auto;" />
 ...
 * @returns {{ subject: string, html: string }}
 */
export function getApprovalEmailContent({ role = "partner", email, recipientName, loginUrl }) {
